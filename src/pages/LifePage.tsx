...
export function LifePage() {
  ...
  return (
    <main className="portrait-page life-page">
      <PageIntro
        eyebrow="The Personal Record / Life & Formation"
        title="I keep finding the strength."
        className="home-hero page-boundary"
      >
        <blockquote>
          “The people saved me. Now it's my turn.”
        </blockquote>
        <p className="home-hero-lede">
          I survived a childhood that taught me to hide, and became a man who lives in the open.
          This page preserves the roots, family, foster children, hard lessons, and personal values
          that give every system its purpose.
        </p>
      </PageIntro>
      ...
      <section className="manifesto-band">
        <div className="page-boundary manifesto-inner">
          ...
          <p>
            ...
            record is me <span className="keep-together">choosing to look.</span>
          </p>
        </div>
      </section>
      ...
      >
        <div className="page-boundary life-record-grid">
          ...
          <div>
            <p className="portrait-index">What the journey produced</p>
            <h2 id="life-record-title">The record so far.</h2>
      ...
      <section className="home-chapter page-boundary" id="science">
        <div className="nanomaterials-dossier">
          <p className="chapter-tag">
            Master&apos;s Research / Inorganic Chemistry &amp; Nanomaterials (2016 to 2018)
          </p>
          <h3>
          ...
          <div className="nanomaterials-grid">
            ...
            <article className="nanomaterials-card">
              <h4>03 / Site-Selective Platinum Deposition &amp; Interfacial Dynamics</h4>
              <p>
      ...
      <section className="soul-closing aegis-closing page-boundary">
        <p className="portrait-index">The Path Forward</p>
        <blockquote>
          “The people saved me. Now it's my turn.”
        </blockquote>
